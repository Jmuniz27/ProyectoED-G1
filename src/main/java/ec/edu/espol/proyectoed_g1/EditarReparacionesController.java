 ...
 * @author jmuni
 */
public class EditarReparacionesController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        LinkedList<AccidenteServicios> reparaciones = EditarVehiculoController.vehiculoEscogido.getHistorial().getAccidentes();
        ...
        for(AccidenteServicios rep: reparaciones){
            ...
            btnDelete.setOnAction((ActionEvent e) -> {
                ...
                vbReparaciones.getChildren().remove(hbRep);
            });
            hbRep.getChildren().add(btnDelete);
